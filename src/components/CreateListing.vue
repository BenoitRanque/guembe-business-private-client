<template>
  <q-form @submit="submit" @reset="reset" class="q-gutter-y-md" style="width: 640px">
    <div class="text-subtitle2 row q-px-md q-pt-sm">
      Creacion de paquete
      <q-space></q-space>
...
export default {
  ...
  methods: {
    ...
    async createListing () {
      ...
      const query = /* GraphQL */`mutation ($objects: [webstore_listing_insert_input!]!) {
      ...
      const variables = {
        objects: {
          ...this.listing,
          supply: this.listing.supply ? Number(this.listing.supply) : null,
          listing_products: {
